import { View, Text, StyleSheet, FlatList, ListRenderItem, Pressable, ActivityIndicator } from "react-native";
...
const Orders = () => {
  ...
  if(error || !orders){
    return <Text>Error: {error?.message || 'An error occured while fetching data'}</Text>;
  }
  if(orders.length === 0){
    return <Text>No orders created yet</Text>;
  }
