...
-- On Authuser insert, create a new user in the users table
create
...
ALTER TABLE ONLY "public"."order"
    ADD CONSTRAINT "order_user_fkey" FOREIGN KEY ("user") REFERENCES "public"."users"("id") ON UPDATE CASCADE;
...
CREATE POLICY "Allow all operations for users" ON "public"."order" TO "authenticated" USING (true) WITH CHECK (true);



CREATE POLICY "Allow all operations for users" ON "public"."order_item" TO "authenticated" USING (true) WITH CHECK (true);
